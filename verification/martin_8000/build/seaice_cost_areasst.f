...
c     objf_ice    - sea-ice volume
     ...
     &              , objf_ice_export
      ...
      Real*8  objf_smrarea    (nsx,nsy)
      Real*8  objf_smrsst     (nsx,nsy)
      Real*8  objf_smrsss     (nsx,nsy)
     ...
     &              , SEAICE_cutoff_heff
      ...
      Real*8  num_smrarea (nsx,nsy)
      Real*8  num_smrsst  (nsx,nsy)
      Real*8  num_smrsss  (nsx,nsy)
      Real*8  mult_ice
      Real*8  mult_smrarea
      Real*8  mult_smrsst
      Real*8  mult_smrsss
      Real*8  mult_ice_export
      Real*8  SEAICE_clamp_salt
      Real*8  SEAICE_clamp_theta
...
c     cost_ice_flag  - cost_ice flag (see cost_ice.F)
     ...
     &       smrsssbar
      ...
      Real*8 wsmrarea(1-olx:snx+olx,1-oly:sny+oly,nsx,nsy)
      Real*8 wsmrarea0
      Real*8 wmean_smrarea
      common /seaice_cost_weights_r/
     &       wsmrarea
     &     , wsmrarea0
     &     , wmean_smrarea

      Real*8 smrareadat(1-olx:snx+olx,1-oly:sny+oly,nsx,nsy)
...
c     == routine arguments ==
      ...
      Real*8 localbar   (1-olx:snx+olx,1-oly:sny+oly,nsx,nsy)
      Real*8 localobs   (1-olx:snx+olx,1-oly:sny+oly,nsx,nsy)
      Real*8 localweight(1-olx:snx+olx,1-oly:sny+oly,nsx,nsy)
      Real*8 localmask  (1-olx:snx+olx,1-oly:sny+oly,nr,nsx,nsy)
      Real*8 xx_localbar_mean_dummy
      Real*8 mult_local
      Real*8 mytime
      Real*8 localperiod
      Real*8 spminloc
      Real*8 spmaxloc
      Real*8 spzeroloc
      Real*8 objf_local(nsx,nsy)
      Real*8 num_local(nsx,nsy)
