...
C     == Local variables ==
      ...
      Real*8 locMask(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      Real*8 yBand(2), locDr(1)
      Real*8 theMin(2), theMax(2)
      Real*8 theMean(2), theVar(2), theVol(2)
      Real*8 theMeanG, theVolG
      Real*8 theMean1, theMean2, theEnergy
      Real*8 theMin0, theMax0, theSD, theDel2
c     Real*8 dummyRL(6)
      INTEGER i,j,bi,bj
      INTEGER k
